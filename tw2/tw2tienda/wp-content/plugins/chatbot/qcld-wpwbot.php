...
define('QCLD_wpCHATBOT_VERSION', '3.5.2.0');
        ...
        if (isset($_POST['_wpnonce']) && $_POST['_wpnonce']) {
            ...
            if (isset($_POST['submit'])) {
               ...
               if(isset( $_POST["disable_wp_chatbot"])){
                ...
                update_option('qlcd_wp_chatbot_from_email', stripslashes($qlcd_wp_chatbot_from_email));
               ...
               if(isset( $_POST["enable_wp_chatbot_mobile_full_screen"])) {
                ...
                $wp_chatbot_icon = isset( $_POST['wp_chatbot_icon'] ) ? $_POST['wp_chatbot_icon'] : 'icon-3.png';
...
function wpbot_help_page_callback_func(){
	...
	<div class="container" style="margin-right:unset;margin-left:unset;">
		...
		<div class="content form-container" style="padding: 10px;color:#fff">
            ...
            <h2 style="margin-top: 30px;padding-top: 30px;border-top: 2px solid #fff;">WPBot Interaction</h2>

            <h3 class="to-accordion-title qc_accordion_title" data-accordion="qc_accordion_content_first">Predefined intents - Built-in ChatBot Features<span class="to-accordion-open"><i class="fa fa-minus accentColorHover"></i></span></h3>
            ...
            <h3 class="to-accordion-title qc_accordion_title" data-accordion="qc_accordion_content_third" style="padding-top: 20px;margin-top: 20px !important;border-top: 1px solid;">Menu Driven - Created with Conversational Form Builder Addon<span class="to-accordion-open"><i class="fa fa-plus accentColorHover"></i></span></h3>
